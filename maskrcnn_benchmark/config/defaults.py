...
# ============================================================
# CAPE-SGG config (for CAPEPrototypeEmbeddingNetwork)
# ============================================================
_C.MODEL.ROI_RELATION_HEAD.CAPE = CN()
_C.MODEL.ROI_RELATION_HEAD.CAPE.USE_CAPM = True
_C.MODEL.ROI_RELATION_HEAD.CAPE.USE_FASA = True
_C.MODEL.ROI_RELATION_HEAD.CAPE.USE_CLIP_BRIDGE = True
_C.MODEL.ROI_RELATION_HEAD.CAPE.USE_APT = True
_C.MODEL.ROI_RELATION_HEAD.CAPE.CAPM_VARIANT = 'capm'       # 'capm', 'context_bias', 'learnable_gate'
_C.MODEL.ROI_RELATION_HEAD.CAPE.FASA_WEIGHT = 0.1
_C.MODEL.ROI_RELATION_HEAD.CAPE.CAPM_NUM_HEADS = 4
_C.MODEL.ROI_RELATION_HEAD.CAPE.CAPM_TEMPERATURE = 1.0
